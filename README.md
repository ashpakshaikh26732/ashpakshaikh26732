...
Passionate about trustworthy, multimodal AI for healthcare. Building production-grade systems for 3D segmentation, adversarial robustness, federated learning, and assistant tools.

🔭 **Current Focus:** Integrating everything into **MedAI Assistant** – a voice-enabled, robust multimodal system (segmentation + report gen + RAG + foundation models).

🌱 **Latest Win:** Merged RandomElasticDeformation3D layer to Keras-Hub (PR [#2419](https://github.com/keras-team/keras-hub/pull/2419)) – boosting 3D augmentation for Gemma/TPU workflows.
